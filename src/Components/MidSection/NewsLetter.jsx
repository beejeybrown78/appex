...
const NewsLetter =()=>{
    ...
    return(<div className="flex items-center justify-center content-center justify-items-center relative ">
        <div className="sm:flex-col sm:py-10 bottom-14 h-full  flex  justify-evenly bg-darkBlue w-4/5 py-24 rounded-xl translate-y-32 duration-700">
            ...
            <div className="sm:flex-col flex items-center justify-items-center content-center">
                <div className="pb-4 pt-4 w-64 text-white ">
                <Input name="email" type="email" placeholder="Email"
                value={email}
                onChange={(e)=>setEmail(e.target.value)}
                className="text-white " label="Email" />
                </div>
                <div className="">
                <Button onClick={handleEmail} ripple={true} className="ml-2 s">Button</Button>
                </div>
            </div>
        </div>
    </div>)
